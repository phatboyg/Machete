namespace Machete.HL7
{
    ...
    {
        public static IStructure<TSchema> CreateHL7<TSchema>(this IStructureFactorySelector selector, IParser<TSchema> parser,
            Action<IHL7StructureConfigurator<TSchema>> configure = null)
            where TSchema : HL7Entity
        {
            var configurator = new HL7StructureConfigurator<TSchema>(parser);
