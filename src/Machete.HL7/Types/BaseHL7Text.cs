namespace Machete.HL7.Types
{
        ...
        IEquatable<BaseHL7Text>
    {
        ...
        public static bool operator ==(BaseHL7Text left, BaseHL7Text right) => Equals(left, right);

        public static bool operator !=(BaseHL7Text left, BaseHL7Text right) => !Equals(left, right);

        public static bool operator <(BaseHL7Text left, BaseHL7Text right) => string.CompareOrdinal(left.Text, right.Text) < 0;
