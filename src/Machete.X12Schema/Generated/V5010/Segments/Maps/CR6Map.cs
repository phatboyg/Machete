namespace Machete.X12Schema.V5010.Segments.Maps
{
    ...
    public class CR6Map : X12SegmentMap<CR6, X12Entity>
    {
        public CR6Map()
        {
            Id = "CR6";
            ...
            Value(x => x.SkilledNursingFacilityIndicator, 6, x => x.MinLength(1).IsRequired());
            Value(x => x.MedicareCoveredIndicator, 7, x => x.MinLength(1).IsRequired());
            Value(x => x.CertificationType, 8, x => x.MinLength(1).IsRequired());
            ...
            Value(x => x.SecondaryDiagnosisDate, 18, x => x.LongDate());
