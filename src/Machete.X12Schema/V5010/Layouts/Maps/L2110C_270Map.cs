namespace Machete.X12Schema.V5010.Maps
{
        ...
        X12LayoutMap<L2110C_270, X12Entity>
    {
        public L2110C_270Map()
        {
            ...
            Segment(x => x.SpendDownAmount, 1, x => x.Condition = parser => parser.Where(p => p.AmountQualifierCode.IsEqualTo("R")));
            Segment(x => x.SpendDownTotalBilledAmount, 2, x => x.Condition = parser => parser.Where(p => p.AmountQualifierCode.IsEqualTo("PB")));
