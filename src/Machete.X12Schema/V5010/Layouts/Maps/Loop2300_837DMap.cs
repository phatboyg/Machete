namespace Machete.X12Schema.V5010.Maps
{
    ...
    public class Loop2300_837DMap :
        X12LayoutMap<Loop2300_837D, X12Entity>
    {
        public Loop2300_837DMap()
        {
            Id = "2300";
            ...
            Layout(x => x.Loop2310A, 22);
            Layout(x => x.Loop2310B, 23);
            Layout(x => x.Loop2310C, 24);
            Layout(x => x.Loop2310D, 25);
            Layout(x => x.Loop2310E, 26);
            Layout(x => x.Loop2320, 27);
            Layout(x => x.Loop2400, 28);
        }
    }
}