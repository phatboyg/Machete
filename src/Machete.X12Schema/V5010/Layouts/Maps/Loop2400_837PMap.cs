namespace Machete.X12Schema.V5010.Maps
{
        ...
        X12LayoutMap<Loop2400_837P, X12Entity>
    {
        public Loop2400_837PMap()
        {
            ...
            Layout(x => x.Loop2410, 40);
            Layout(x => x.Loop2420A, 41);
            Layout(x => x.Loop2420B, 42);
            Layout(x => x.Loop2420C, 43);
            Layout(x => x.Loop2420D, 44);
            Layout(x => x.Loop2420E, 45);
            Layout(x => x.Loop2420F, 46);
            Layout(x => x.Loop2420G, 47);
            Layout(x => x.Loop2420H, 48);
            Layout(x => x.Loop2430, 49);
            Layout(x => x.Loop2440, 50);
        }
    }
}