namespace Machete.X12Schema.V5010.Maps
{
    ...
    public class Loop2300_837PMap :
        X12LayoutMap<Loop2300_837P, X12Entity>
    {
        public Loop2300_837PMap()
        {
            Id = "2300";
            ...
            Layout(x => x.Loop2310A, 46);
            Layout(x => x.Loop2310B, 47);
            Layout(x => x.Loop2310C, 48);
            Layout(x => x.Loop2310D, 49);
            Layout(x => x.Loop2310E, 50);
            Layout(x => x.Loop2310F, 51);
            Layout(x => x.Loop2320, 52);
            Layout(x => x.Loop2400, 53);
        }
    }
}