namespace Machete.X12.Tests.Layouts
{
    ...
    [TestFixture]
    public class Parsing837ProfessionalL2300P1ConditionalTests :
        X12MacheteTestHarness<V5010, X12Entity>
    {
        [Test(Description = @"Condition : OnsetOfCurrentIllnessDate => 431,
            ...
            DisabilityDates => 314,
            LastWorkedDate => 297,
            AuthorizedReturnToWork => 296,
            AdmissionDate => 435,
            DischargeDate => 096,
            AssumedRelinquishedCareDates => 090,
            PropertyAndCasualtyDateOfFirstContact => 444,
...
IEA*1*176073292";
            ...
            Assert.IsTrue(authorizedReturnToWork.HasValue);
            Assert.IsTrue(authorizedReturnToWork.IsPresent);
            ...
            Assert.IsTrue(admissionDate.HasValue);
            Assert.IsTrue(admissionDate.IsPresent);
            ...
            Assert.IsTrue(dischargeDate.HasValue);
            Assert.IsTrue(dischargeDate.IsPresent);
            ...
            Assert.IsTrue(assumedRelinquishedCareDates.HasValue);
            Assert.IsTrue(assumedRelinquishedCareDates.IsPresent);
            ...
            Assert.IsTrue(propertyAndCasualtyDateOfFirstContact.HasValue);
            Assert.IsTrue(propertyAndCasualtyDateOfFirstContact.IsPresent);
            Assert.AreEqual("444", propertyAndCasualtyDateOfFirstContact.ValueOrDefault());
