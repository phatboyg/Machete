namespace Machete.X12.Tests.Layouts
{
    ...
    [TestFixture]
    public class Parsing837ProfessionalL2400P6ConditionalTests :
        X12MacheteTestHarness<V5010, X12Entity>
    {
        [Test(Description = @"Condition : SalesTaxAmount => T, PostageClaimedAmount => F4")]
        public void Test1()
        {
            string message =
...
IEA*1*176073292";
            ...
            Assume.That(salesTaxAmount != null);
            Assert.IsTrue(salesTaxAmount.HasValue);
            Assert.IsTrue(salesTaxAmount.IsPresent);
            ...
            Assume.That(postageClaimedAmount != null);
            Assert.IsTrue(postageClaimedAmount.HasValue);
            Assert.IsTrue(postageClaimedAmount.IsPresent);
            Assert.AreEqual("F4", postageClaimedAmount.ValueOrDefault());
        }

        [Test(Description = @"Condition : SalesTaxAmount => missing, PostageClaimedAmount => F4")]
        public void Test2()
        {
            string message =
                @"ISA*00*          *00*          *ZZ*EMEDNYBAT      *ZZ*00DJ           *180625*0712*^*00501*176073292*0*P*:
...
IEA*1*176073292";
            ...
            Assume.That(salesTaxAmount != null);
            Assert.IsFalse(salesTaxAmount.HasValue);
        ...
        [Test(Description = @"Condition : SalesTaxAmount => T, PostageClaimedAmount => missing")]
        public void Test3()
        {
            string message =
                @"ISA*00*          *00*          *ZZ*EMEDNYBAT      *ZZ*00DJ           *180625*0712*^*00501*176073292*0*P*:
...
IEA*1*176073292";
            ...
            Assume.That(postageClaimedAmount != null);
            Assert.IsFalse(postageClaimedAmount.HasValue);
            Assert.IsFalse(postageClaimedAmount.IsPresent);
        }

        [Test(Description = @"Condition : SalesTaxAmount => missing, PostageClaimedAmount => missing")]
        public void Test4()
        {
            string message =
                @"ISA*00*          *00*          *ZZ*EMEDNYBAT      *ZZ*00DJ           *180625*0712*^*00501*176073292*0*P*:
