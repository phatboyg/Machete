namespace Machete.X12.Tests.Layouts
{
    ...
    [TestFixture]
    public class Parsing837ProfessionalL2010ACConditionalTests :
        X12MacheteTestHarness<V5010, X12Entity>
    {
        [Test(Description = "Condition : SecondaryIdentification => 2U, TaxIdNumber => EIB")]
        public void Test1()
        {
            string message =
...
IEA*1*176073292";
            ...
            Assert.AreEqual("EIB", taxIdNumber.ValueOrDefault());
        }
        
        [Test(Description = "Condition : SecondaryIdentification => FY, TaxIdNumber => EIB")]
        public void Test2()
        {
            string message =
                @"ISA*00*          *00*          *ZZ*EMEDNYBAT      *ZZ*00DJ           *180625*0712*^*00501*176073292*0*P*:
...
IEA*1*176073292";
        ...
        [Test(Description = "Condition : SecondaryIdentification => NF, TaxIdNumber => EIB")]
        public void Test3()
        {
            string message =
                @"ISA*00*          *00*          *ZZ*EMEDNYBAT      *ZZ*00DJ           *180625*0712*^*00501*176073292*0*P*:
...
IEA*1*176073292";
        ...
        [Test(Description = "Condition : SecondaryIdentification => missing, TaxIdNumber => EIB")]
        public void Test4()
        {
            string message =
                @"ISA*00*          *00*          *ZZ*EMEDNYBAT      *ZZ*00DJ           *180625*0712*^*00501*176073292*0*P*:
