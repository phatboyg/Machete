namespace Machete.X12.Tests.Layouts
{
    ...
    [TestFixture]
    public class Parsing837ProfessionalL2400P5ConditionalTests :
        X12MacheteTestHarness<V5010, X12Entity>
    {
        [Test(Description = @"Condition : AmbulancePatientCount => PT, ObstetricAnesthesiaAdditionalUnits => FL")]
        public void Test1()
        {
            string message =
...
IEA*1*176073292";
            ...
            Assume.That(ambulancePatientCount != null);
            Assert.IsTrue(ambulancePatientCount.HasValue);
            Assert.IsTrue(ambulancePatientCount.IsPresent);
            ...
            Assume.That(obstetricAnesthesiaAdditionalUnits != null);
            Assert.IsTrue(obstetricAnesthesiaAdditionalUnits.HasValue);
            Assert.IsTrue(obstetricAnesthesiaAdditionalUnits.IsPresent);
            Assert.AreEqual("FL", obstetricAnesthesiaAdditionalUnits.ValueOrDefault());
        }

        [Test(Description = @"Condition : AmbulancePatientCount => PT, ObstetricAnesthesiaAdditionalUnits => missing")]
        public void Test2()
        {
            string message =
                @"ISA*00*          *00*          *ZZ*EMEDNYBAT      *ZZ*00DJ           *180625*0712*^*00501*176073292*0*P*:
...
IEA*1*176073292";
            ...
            Assume.That(obstetricAnesthesiaAdditionalUnits != null);
            Assert.IsFalse(obstetricAnesthesiaAdditionalUnits.HasValue);
            Assert.IsFalse(obstetricAnesthesiaAdditionalUnits.IsPresent);
        }

        [Test(Description = @"Condition : AmbulancePatientCount => missing, ObstetricAnesthesiaAdditionalUnits => FL")]
        public void Test3()
        {
            string message =
                @"ISA*00*          *00*          *ZZ*EMEDNYBAT      *ZZ*00DJ           *180625*0712*^*00501*176073292*0*P*:
...
IEA*1*176073292";
            ...
            Assume.That(ambulancePatientCount != null);
            Assert.IsFalse(ambulancePatientCount.HasValue);
        ...
        [Test(Description = @"Condition : AmbulancePatientCount => missing, ObstetricAnesthesiaAdditionalUnits => missing")]
        public void Test4()
        {
            string message =
                @"ISA*00*          *00*          *ZZ*EMEDNYBAT      *ZZ*00DJ           *180625*0712*^*00501*176073292*0*P*:
