namespace Machete.X12.Tests.Layouts
{
    ...
    [TestFixture]
    public class Parsing837ProfessionalL2300P10ConditionalTests :
        X12MacheteTestHarness<V5010, X12Entity>
    {
        [Test(Description = @"Condition : ServiceAuthorizationExceptionCode => 4N,
            ...
            PayerClaimControlNumber => F8,
            CLIANumber => X4,
            RepricedClaimNumber => 9A,
            AdjustedRepricedClaimNumber => 9C,
            InvestigationalDeviceExemptionNumber => LX,
            ClaimIdentifierForTransmissionIntermediaries => D9,
            MedicalRecordNumber => E4,
            DemonstrationProjectIdentifier => P4,
            CarePlanOversight => 1J")]
        public void Test1()
        {
            string message =
