namespace Machete.X12.Tests.Layouts
{
    ...
    [TestFixture]
    public class Parsing837ProfessionalL2300P9ConditionalTests :
        X12MacheteTestHarness<V5010, X12Entity>
    {
        [Test(Description = @"Condition : OnsetOfCurrentIllnessDate => 431,
            ...
            AccidentDate => 439,
            LastMensrualPeriod => missing,
            LastXRayDate => missing,
            HearingVisionPrescriptionDate => missing,
            DisabilityDates => missing,
            LastWorkedDate => missing,
...
IEA*1*176073292";
            ...
            Assert.IsFalse(lastMensrualPeriod.HasValue);
            Assert.IsFalse(lastMensrualPeriod.IsPresent);
            ...
            Assert.IsFalse(hearingVisionPrescriptionDate.HasValue);
            Assert.IsFalse(hearingVisionPrescriptionDate.IsPresent);
            ...
            Assert.IsFalse(disabilityDates.HasValue);
            Assert.IsFalse(disabilityDates.IsPresent);
            ...
            Assert.IsFalse(lastWorkedDate.HasValue);
            Assert.IsFalse(lastWorkedDate.IsPresent);
...
IEA*1*176073292";
            ...
            Assume.That(accidentDate != null);
            Assert.IsFalse(accidentDate.HasValue);
            Assert.IsFalse(accidentDate.IsPresent);
        ...
        [Test(Description = @"Condition : OnsetOfCurrentIllnessDate => 431,
            InitialTreatmentDate => 454,
            LastSeenDate => 304,
            AcuteManifestationDate => missing,
            AccidentDate => missing,
            LastMensrualPeriod => missing,
            LastXRayDate => missing,
            HearingVisionPrescriptionDate => missing,
...
IEA*1*176073292";
            ...
            Assume.That(acuteManifestationDate != null);
            Assert.IsFalse(acuteManifestationDate.HasValue);
            Assert.IsFalse(acuteManifestationDate.IsPresent);
...
IEA*1*176073292";
            ...
            Assume.That(repricerReceivedDate != null);
            Assert.IsTrue(repricerReceivedDate.HasValue);
            Assert.IsTrue(repricerReceivedDate.IsPresent);
            Assert.AreEqual("050", repricerReceivedDate.ValueOrDefault());
        }
...
IEA*1*176073292";
        ...
        [Test(Description = @"Condition : OnsetOfCurrentIllnessDate => missing,
            InitialTreatmentDate => missing,
            LastSeenDate => missing,
            AcuteManifestationDate => missing,
            AccidentDate => missing,
...
IEA*1*176073292";
            ...
            Assume.That(onsetOfCurrentIllnessDate != null);
            Assert.IsFalse(onsetOfCurrentIllnessDate.HasValue);
            Assert.IsFalse(onsetOfCurrentIllnessDate.IsPresent);
