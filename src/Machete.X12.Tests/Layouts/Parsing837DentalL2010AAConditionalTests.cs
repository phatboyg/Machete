namespace Machete.X12.Tests.Layouts
{
    ...
    [TestFixture]
    public class Parsing837DentalL2010AAConditionalTests :
...
IEA*1*176073292";
            ...
            Assert.IsTrue(upin.IsPresent);
            Assert.AreEqual("OB", upin.ValueOrDefault());
        }
...
IEA*1*176073292";
            ...
            Assert.IsTrue(upin.HasValue);
            Assert.IsTrue(upin.IsPresent);
            Assert.AreEqual("1G", upin.ValueOrDefault());
        }
