...
IEA*1*000026531";
        ...
        [Test]
        public void Should_not_throw_exception_when_repetition_delimiter_is_char()
        {
            const string message =
                @"ISA*03*6327      *01*NFMC01    *ZZ*MACHETE        *ZZ*PERSEPVS       *090601*0406*U*00501*000026531*0*P*:
GS*HB*FL0738*PERSEPVS*20090601*040612*1*X*005010X279
ST*271*4321*005010X279
BHT*0022*11*10001234*20060501*1319
HL*1**20*1
