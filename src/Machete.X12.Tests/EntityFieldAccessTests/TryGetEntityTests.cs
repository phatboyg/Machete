...
IEA*1*000026531";
            ...
            ParseResult<X12Entity> parse = Parser.Parse(message);

            Assert.IsTrue(parse.TryGetEntity(5, out X12Segment segment));
            Assert.IsTrue(segment is PER);
        }
...
IEA*1*000026531";
            ...
            Assert.IsFalse(parse.TryGetEntity(-1, out X12Segment _));
        }
...
IEA*1*000026531";
            ...
            Assert.IsFalse(parse.TryGetEntity(100, out X12Segment _));
        }
    }
}