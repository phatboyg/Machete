namespace Machete.TranslatorConfiguration.Specifications
{
        ...
        where TInput : TSchema
    {
        ...
        public override void Apply(IEntityTranslatorBuilder<TResult, TInput, TSchema> builder)
        {
            ...
            var translator = new CreateEntityValuePropertyTranslator<TResult, TEntity, TInput, TSchema>(ResultPropertyInfo, entityTranslator);
    ...
    public class CreateEntityValueUsingSpecification<TResult, TDescription, TEntity, TSchema> :
        ...
        where TResult : TSchema
    {
        ...
        public override void Apply(IEntityCreatorBuilder<TResult, TSchema> builder)
        {
            ...
            var translator = new CreateEntityValuePropertyTranslator<TResult, TEntity, TSchema>(ResultPropertyInfo, entityTranslator);
