...
namespace Machete.HL7Schema.V26.Maps
{
        ...
        HL7SegmentMap<PV1>
    {
        public PV1Map()
        {
            ...
            Value(x => x.DeleteAccountDate, 35, x => {x.Format = "LONGDATE35";});
            ...
            Value(x => x.AdmitDateTime, 44, x => {x.Format = "LONGDATETIME44";});
            Value(x => x.DischargeDateTime, 45, x => {x.Format = "LONGDATETIME45";});
