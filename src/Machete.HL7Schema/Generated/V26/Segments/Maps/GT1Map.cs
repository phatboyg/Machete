...
namespace Machete.HL7Schema.V26.Maps
{
        ...
        HL7V26SegmentMap<GT1>
    {
        public GT1Map()
        {
            ...
            Value(x => x.GuarantorDateTimeOfBirth, 8, x => {x.Converter = HL7.HL7ValueConverters.VariableLongDateTime;});
            ...
            Value(x => x.GuarantorDateBegin, 13, x => {x.Converter = HL7.HL7ValueConverters.VariableLongDateTime;});
            Value(x => x.GuarantorDateEnd, 14, x => {x.Converter = HL7.HL7ValueConverters.VariableLongDateTime;});
            ...
            Value(x => x.GuarantorDeathDateAndTime, 24, x => {x.Converter = HL7.HL7ValueConverters.VariableLongDateTime;});
            ...
            Value(x => x.GuarantorHireEffectiveDate, 31, x => {x.Converter = HL7.HL7ValueConverters.VariableLongDateTime;});
            Value(x => x.EmploymentStopDate, 32, x => {x.Converter = HL7.HL7ValueConverters.VariableLongDateTime;});
