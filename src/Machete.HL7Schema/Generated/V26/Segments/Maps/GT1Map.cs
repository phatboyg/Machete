...
namespace Machete.HL7Schema.V26.Maps
{
        ...
        HL7SegmentMap<GT1>
    {
        public GT1Map()
        {
            ...
            Value(x => x.GuarantorDateTimeOfBirth, 8, x => {x.Format = "LONGDATETIME8";});
            ...
            Value(x => x.GuarantorDateBegin, 13, x => {x.Format = "LONGDATE13";});
            Value(x => x.GuarantorDateEnd, 14, x => {x.Format = "LONGDATE14";});
            ...
            Value(x => x.GuarantorDeathDateAndTime, 24, x => {x.Format = "LONGDATETIME24";});
            ...
            Value(x => x.GuarantorHireEffectiveDate, 31, x => {x.Format = "LONGDATE31";});
            Value(x => x.EmploymentStopDate, 32, x => {x.Format = "LONGDATE32";});
