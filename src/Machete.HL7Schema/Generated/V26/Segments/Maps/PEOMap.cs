...
namespace Machete.HL7Schema.V26.Maps
{
        ...
        HL7SegmentMap<PEO>
    {
        public PEOMap()
        {
            ...
            Value(x => x.EventOnsetDateTime, 3, x => {x.Format = "LONGDATETIME3";x.Required = true;});
            Value(x => x.EventExacerbationDateTime, 4, x => {x.Format = "LONGDATETIME4";});
            Value(x => x.EventImprovedDateTime, 5, x => {x.Format = "LONGDATETIME5";});
            Value(x => x.EventEndedDataTime, 6, x => {x.Format = "LONGDATETIME6";});
            ...
            Value(x => x.PrimaryObserverAwareDateTime, 24, x => {x.Format = "LONGDATETIME24";});
