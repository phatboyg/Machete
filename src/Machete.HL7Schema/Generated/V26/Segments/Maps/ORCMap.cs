...
namespace Machete.HL7Schema.V26.Maps
{
        ...
        HL7SegmentMap<ORC>
    {
        public ORCMap()
        {
            ...
            Entity(x => x.Parent, 8);
            Value(x => x.DateTimeOfTransaction, 9, x => {x.Format = "LONGDATETIME9";});
            ...
            Value(x => x.OrderEffectiveDateTime, 15, x => {x.Format = "LONGDATETIME15";});
            ...
            Value(x => x.FillerSExpectedAvailabilityDateTime, 27, x => {x.Format = "LONGDATETIME27";});
