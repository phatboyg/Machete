...
namespace Machete.HL7Schema.V26.Maps
{
        ...
        HL7V26SegmentMap<PID>
    {
        public PIDMap()
        {
            ...
            Entity(x => x.AccountNumber, 18);
            Value(x => x.SocialSecurityNumber, 19);
            Entity(x => x.DriverLicenseNumber, 20);
            Entity(x => x.MotherIdentifier, 21);
            ...
            Value(x => x.DeathDateTime, 29, x => x.Converter = HL7.HL7ValueConverters.VariableLongDateTime);
            Value(x => x.DeathIndicator, 30);
