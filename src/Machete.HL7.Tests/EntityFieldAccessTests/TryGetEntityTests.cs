namespace Machete.HL7.Tests.EntityFieldAccessTests
{
    ...
    {
        [Test]
        public void Should_be_able_to_get_segment_text_slice()
        {
...
NTE|2||dsa";
        ...
        [Test]
        public void Should_not_throw_when_trying_to_get_entity_at_index_less_than_max()
        {
            const string message = @"MSH|^~\&|MACHETELAB|^DOSC|MACHETE|18779|20130405125146269||ORM^O01|1999077678|P|2.3|||AL|AL
NTE|1||KOPASD
NTE|2||A3RJ
...
NTE|2||dsa";
            ...
            Assert.IsFalse(parse.TryGetEntity(-1, out HL7Segment _));
        }
        
        [Test]
        public void Should_not_throw_when_trying_to_get_entity_at_index_beyond_max()
        {
            const string message = @"MSH|^~\&|MACHETELAB|^DOSC|MACHETE|18779|20130405125146269||ORM^O01|1999077678|P|2.3|||AL|AL
NTE|1||KOPASD
NTE|2||A3RJ
...
NTE|2||dsa";
            ...
            Assert.IsFalse(parse.TryGetEntity(100, out HL7Segment _));
        }
    }
}