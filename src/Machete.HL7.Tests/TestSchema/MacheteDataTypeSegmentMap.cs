namespace Machete.HL7.Tests.TestSchema
{
        ...
        HL7SegmentMap<MacheteDataTypeSegment, HL7Segment>
    {
        public MacheteDataTypeSegmentMap()
        {
            ...
            Value(x => x.DateTimeField, 9, x => { x.Converter = HL7ValueConverters.VairableShortDateTime; x.MaxLength = 10; });
            ...
            Value(x => x.DateTimeListField, 20, x => { x.Converter = HL7ValueConverters.VairableShortDateTime; x.MaxLength = 10; });
